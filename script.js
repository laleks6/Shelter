...
const sliderBlockForWindowWight = (quantity) => {
    ...
    const creatCards = (quantity) => {
        ...
        for(let i = 0; i < quantity; i++) {
            ...
            divCardaPrepend.classList.add("pets_cards", "curso--pointer", "cards__left", "card__replicant");
            ...
            buttonCardaPrepend.classList.add("btn__cards", "button", "curso--pointer", "btn__replicant");
        
            //after main pack cards
            slider.appendChild(divCardaAppend);
            divCardaAppend.classList.add("pets_cards", "curso--pointer", "cards__right", "card__replicant");
            ...
            buttonCardaAppend.classList.add("btn__cards", "button", "curso--pointer", "btn__replicant");
    ...
    const cheingReplicantImg = document.getElementsByClassName("img__replicant");
    const cheingReplicantName = document.getElementsByClassName("name__replicant");
    const cheingReplicantBtn = document.getElementsByClassName("btn__replicant");
    ...
    const fillContentSecondBlockCards = () => {
        if(slider.classList.contains('addPastCards')){
            ...
            for(let i = 0; i < cardsReplicant.length; i++) {
                ...
                cheingReplicantName[i].textContent = dataCards[+arrPastSet[i]]["name"]
